...
class ProtobufCodec : muduo::noncopyable
{
 public:
  ...
  void send(int id, const muduo::net::TcpConnectionPtr& conn,
 ...
 private:
  static void defaultErrorCallback(int id, const muduo::net::TcpConnectionPtr&,
                                   muduo::net::Buffer*,
                                   muduo::Timestamp,
                                   ErrorCode);
  ...
  ErrorCallback errorCallback_;
	...
	const static int kIdLen = sizeof(int16_t);
