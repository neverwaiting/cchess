...
class Callback : muduo::noncopyable
{
 public:
  ...
  virtual void onMessage(int id, const muduo::net::TcpConnectionPtr&,
...
class CallbackT : public Callback
{
 ...
 public:
  typedef std::function<void (int id, const muduo::net::TcpConnectionPtr&,
...
class ProtobufDispatcher
{
 public:
  ...
  void onProtobufMessage(int id, const muduo::net::TcpConnectionPtr& conn,
                         const MessagePtr& message,
                         muduo::Timestamp receiveTime) const
  {
    ...
    {
      it->second->onMessage(id, conn, message, receiveTime);
    }
    else
    {
      defaultCallback_(id, conn, message, receiveTime);
    }
  }
